	...
	/** @lends CKEDITOR.dom.element.prototype */
	{
		...
		getDocumentPosition : function( refDocument )
		{
			...
			if ( document.documentElement[ "getBoundingClientRect" ] )
			{
				 ...
				 *
				 * On IE, the top position of the <!DOCTYPE html> element is always 0, no matter
				 * how much you scrolled down.
				 *
				 * On other browsers, the top position of the <!DOCTYPE html> element is negative
				 * scrollTop.
				 */
				if ( CKEDITOR.env.ie )
				{
		...
		scrollIntoParent : function( parent, alignToTop, hscroll )
		{
			...
			// On window <!DOCTYPE html> is scrolled while quirks scrolls <body>.
