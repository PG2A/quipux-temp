...
include_once(dirname(__DIR__).'/metadatos/metadatos_funciones.php');
...
$codTx = trim(limpiar_sql($_GET['codTx'] ?? '0'));
...
<body >
  <form method="post" name="frmMetadatos" action="../metadatos/metadatos_radi_grabar.php">
    ...
    if ($mensaje_error != "" )
        echo ("<table class='borde_tab' width='100%' cellspacing=0>
               ...
               <tr><td width='100%' align='center'><input type='button' value='Regresar' onClick='regresarQuipux();' name='enviardoc' class='botones' id='Cancelar'></td></tr>               
               </table></center>");
    else{ ?>
                        ...
                        <tr><td  colspan="4">
                            <table width="100%">
                                <?php         
                                    ...
                                    $ruta_raiz = '..'; // Directorio raiz para las imagenes
