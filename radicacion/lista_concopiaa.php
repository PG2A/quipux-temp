...
if (isset ($replicacion) && $replicacion && $config_db_replica_lista_concopia!="") {
    $db = new ConnectionHandler(dirname(__DIR__), $config_db_replica_lista_concopia);
}
...
<table  width="100%" border="0" cellpadding="0" cellspacing="0">
	...
	<td width='21%' CLASS=titulos2 ><?=$descEmpresa ?? 'Institución'?></td>
