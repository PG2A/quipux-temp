         ...
         //--?>
            <table width="100%"  align="center" border="0" cellspacing="0" cellpadding="3" rules="rows" >
                <tr <?php if ($raditipo!=1 and $raditipo!='' || $raditipo==6) echo "style='display: none;'"?>>
                    <td colspan="2">
                        <input type="checkbox" name="chk_documento" id="chk_documento" value="1" <?php echo ($chkOculta=='checked'?'checked':'')?> onclick="histop('a',this,'<?php echo $chkOculta?>');"/>
                ...
                <tr <?php if ($raditipo==6) echo "style='display: none;'"?>>
                    <td colspan="2" <?php if ($raditipo==6) echo "style='display: none;'"?>>
                        <input type="checkbox" name="chk_asunto" id="chk_asunto" value="1" <?php echo (($chkAsunto??'')=='checked'?'checked':'')?> onclick="histop('o',this,'<?php echo $chkAsunto??''?>');"/>
                        Ocultar Asunto
                    </td>
                </tr>
                <tr <?php if ($raditipo==6) echo "style='display: none;'"?>>
                    <td colspan="2">
                        <input type="checkbox" name="chk_italica" id="chk_italica" value="1" <?php echo (($chkItalica??'')=='checked'?'checked':'')?> onclick="histop('li',this,'<?php echo $chkItalica??''?>');"/>
                 ...
                 <tr <?php if ($raditipo==6) echo "style='display: none;'"?>>
                    <td colspan="2">
                        <input type="checkbox" name="chk_referencia" id="chk_referencia" value="1" <?php echo (($chkReferencia??'')=='checked'?'checked':'')?> onclick="histop('re',this,'<?php echo $chkReferencia??''?>');"/>
                        Ocultar Referencia
                    </td>
                </tr>
                <tr <?php if ($raditipo==6) echo "style='display: none;'"?>>
                    <td colspan="2">
                        <input type="checkbox" name="chk_anexo" id="chk_anexo" value="1" <?php echo (($chkAnexo??'')=='checked'?'checked':'')?> onclick="histop('ax',this,'<?php echo $chkAnexo??''?>');"/>
                        Ocultar Anexos
                    </td>
                </tr>
                <tr <?php if ($raditipo==6) echo "style='display: none;'"?>>
    ...
    <br>    
        <fieldset style="display:<?=$_POST['verDest']?>" class="borde_tab" id="D">
            ...
            <tr id="T" <?php if ($cmb_tipo_imp==2) echo "style='display:none'"; ?>>
                ...
                <td width="2%">
                    <img src="../imagenes/internas/pencil_add.png" onclick='habilitaObj("tit");' name="Image1" align="middle" border="0" title="Modifica el título del destinatario"/>
                </td>
           ...
           <tr id="N" <?php if ($cmb_tipo_imp==2 || $cmb_tipo_imp==6) echo "style='display:none'"; ?>>
                ...
                <td width="2%">
                    <img src="../imagenes/internas/pencil_add.png" onclick='habilitaObj("firm");' <?=$visible?> name="ImgFirm" id="ImgFirm" align="middle" border="0" title="Añadir texto al destinatario">
                </td>                
                <td>
                <?php 
                //usuario con firma                
            ...
            <tr id="trCargo" <?php if ($cmb_tipo_imp==5) echo "style='display:none'"; ?>>
                ...
                <td width="2%">
                    ...
                    <img src="../imagenes/internas/pencil_add.png" onclick='habilitaObj("carg");' name="Image1" align="middle" border="0" title="Modifica el Puesto de la cabecera del documento.">
                    <?php }?>
                </td>
                <td width="30%"></td>
            </tr>
            <tr id="trInstitucion" <?php if ($cmb_tipo_imp==4) echo "style='display:none'"; ?>>
                ...
                <td>
                    <img src="../imagenes/internas/pencil_add.png" name="ImgInst" id="ImgInst" <?=$visible?> align="middle" border="0" title="Añade frase a la institución" onclick="habilitaObj('ins')">
                </td>
        ...
        <fieldset  class="borde_tab">
            ...
            <table>
                <tr>
                    ...
                    <td>
                        <img src="../imagenes/internas/pencil_add.png" name="Image1" align="middle" border="0" title="Modifica el saludo" onclick="habilitaObj('sal')">
                    
                        <img src="../imagenes/internas/application_home.png" name="Image1" align="middle" border="0" title="Añade la ciudad ó dirección del funcionario ó ciudadano (Destinatario)" onclick="habilitaObj('dir')">
                    </td>
        ...
        <table width="100%" align="center" border="0" cellspacing="0" cellpadding="3" rules="rows">
                ...
                <td align="left" colspan="2">
                    ...
                    if ($raditipo==6){
                     ...
                     if ($rsOpcImprBusq['JUSTIFICAR_FIRMA']==0){
                      ...
                      echo '<input type="radio" name="radio_justifi" '.$funcionjava.' id="radio_justifi" value="1" '.($chkJustificaFir=='checked'?'checked':'').'>Centro';
                     }else{
                      echo '<input type="radio" name="radio_justifi" '.$funcionjava.' id="radio_justifi" value="0" '.($chkJustificaFir=='checked'?'checked':'').'>Izquierda';
            ...
            <tr>
                ...
                <td width="2%">
                    <img src="../imagenes/internas/pencil_add.png" name="Image1" align="middle" border="0"   title="Modifica la despedida del documento" onclick="habilitaObj('des')"/>
                </td>                
                
                <td class="listado1_ver" width="25%">Ocultar Atentamente: <input type="checkbox" name="chk_OcultaAtentamente" id="chk_OcultaAtentamente" value="1" <?php echo (($chkAtentamente??'')=='checked'?'checked':'')?> onclick="histop('j',this,'<?php echo $chk_OcultaAtentamente??''?>');"> </td>
            </tr>
            <tr>
                ...
                <td width="2%">
                    <img src="../imagenes/internas/pencil_add.png" name="Image1" align="middle" border="0" title="Añade una frase a la despedida" onclick="habilitaObj('fra');"/>
                </td>               
                <td class="listado1_ver" width="25%">Ocultar frase despedida: <input type="checkbox" name="chk_opcFraseDespedida" id="chk_opcFraseDespedida" value="1" <?php echo (($chkOcultaFrase??'')=='checked'?'checked':'')?> onclick="histop('j',this,'<?php echo $chkOcultaFrase??''?>');"> </td>
             </tr>
             <?php } ?>
        </table>
        </fieldset>
