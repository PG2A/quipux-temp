...
<script type="text/javascript" >
    ...
    function ver_documento(path_archivo , nombre_archivo) {
        path_descarga = '/archivo_descargar.php?path_arch=' + path_archivo + '&nomb_arch=' + nombre_archivo;
        ...
        <table border="0" cellpadding="0" cellspacing="5" class="borde_tab" width="98%">
            ...
            <tr>
                <td class="listado1" align='center' valign='top' colspan="2">
                    ...
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <input type='button' name="btn_accion" value='Regresar' onClick="regresarQuipux();" class='botones'>
                    <br><br>
                </td>
            </tr>
        </table>
