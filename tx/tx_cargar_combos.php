...
if (isset ($replicacion) && $replicacion && $config_db_replica_tx_cargar_combos!="") {
    $db = new ConnectionHandler(dirname(__DIR__), $config_db_replica_tx_cargar_combos);
}
...
//                    }
        ...
        case "reasignar_respuesta": // Si se respondio un documento mostrar el check
            $tarea_codi = (int)$_POST["tarea_codi"];
