...
$paginador = new ADODB_Pager_Ajax(dirname(__DIR__), "div_buscar_documentos", "revertir_firma_digital_busqueda.php", "txt_nume_documento");
$descRadicado = isset($_SESSION["descRadicado"]) ? $_SESSION["descRadicado"] : "Radicado";
$txt_nume_documento = isset($_POST["txt_nume_documento"]) ? $_POST["txt_nume_documento"] : "";
?>
