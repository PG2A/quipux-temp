...
$txt_nume_documento = isset($_GET['txt_nume_documento']) ? $_GET['txt_nume_documento'] : '';
...
if (!$orderNo) $orderNo = 2;
    ...
    $isql = "select -- revertir firma digital
            ...
            from (
                ...
                from (
                    ...
                    from radicado r
                    where r.radi_inst_actu=" . (isset($_SESSION["inst_codi"]) ? $_SESSION["inst_codi"] : 0) . "
    ...
    // ADODB will fetch limit+1 to determine if Next page exists
