...
$paginador = new ADODB_Pager_Ajax(dirname(__DIR__), "div_lista_documentos", "../tipo_documental/lista_documentos_paginador.php", "trd_codi,trd_nombre_completo","trd_boton=0");
?>
...
<?
    $boton = "";
    $descTRD = $descTRD ?? 'Carpeta Virtual';
    $descDependencia = $descDependencia ?? 'Área';
//    if (!isset($trd_codi)) {
...
<?
        ...
        if ($codexp == 0) {
            ...
            echo '<tr><td class="listado1">'.$area_actual.'</td><td class="listado1">'.$nombre_completo.'</td></tr>';
        }
