...
$db = new ConnectionHandler(dirname(__DIR__),$config_db_replica_contenido_index);
...
if ($activar_bloqueo_sistema) {
    if (is_file(dirname(__DIR__)."/bodega/mensaje_bloqueo_sistema.html")) {
        $mensaje = file_get_contents(dirname(__DIR__)."/bodega/mensaje_bloqueo_sistema.html");
...
echo "<!DOCTYPE html>".html_head(false,true); /*Imprime el head definido para el sistema*/
//echo html_validar_browser(); /*Valida el browser*/
?>
<!DOCTYPE html>
    <head>
        <title>Quipux - Sistema Documental Universidad de Cuenca</title>
        <meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
        <meta name="description" content="Quipux Sistema Documental Universidad de Cuenca" />
        <meta name="keywords" content="Quipux, Sistema Documental Universidad de Cuenca"/>
...
<!--                                <div class="slideContent">
                        ...
                        <div id="slide2" class="slide"> <img src="../imagenes/index/banner_fijo_index2.jpg" alt="" width="600" height="150" />
<!--                            <div class="slideContent">
                            <h3>W3C Valid</h3>
                            <p>Are you a stickler for writing valid code?  So is jFlow.  Run this puppy through W3C's validator to see it pass the test!</p>
                            </div>-->
                        </div>
			<div id="slide3" class="slide"> <img src="../imagenes/index/banner_fijo_index3.jpg" alt="" width="600" height="150" />
<!--                            <div class="slideContent">
                            <h3>W3C Valid</h3>
                            <p>Are you a stickler for writing valid code?  So is jFlow.  Run this puppy through W3C's validator to see it pass the test!</p>
                            </div>-->
