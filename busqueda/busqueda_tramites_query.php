...
$ruta_raiz = "..";
if (!$db->driver){ $db = $this->db; }

// Initialize variables to avoid warnings
$txt_nume_documento = isset($_REQUEST["txt_nume_documento"]) ? $_REQUEST["txt_nume_documento"] : "";
$txt_nume_referencia = isset($_REQUEST["txt_nume_referencia"]) ? $_REQUEST["txt_nume_referencia"] : "";
$txt_usua_remitente = isset($_REQUEST["txt_usua_remitente"]) ? $_REQUEST["txt_usua_remitente"] : "";
$txt_usua_destinatario = isset($_REQUEST["txt_usua_destinatario"]) ? $_REQUEST["txt_usua_destinatario"] : "";
$txt_texto = isset($_REQUEST["txt_texto"]) ? $_REQUEST["txt_texto"] : "";
$txt_depe_codi = isset($_REQUEST["txt_depe_codi"]) ? $_REQUEST["txt_depe_codi"] : "0";
$txt_usua_codi = isset($_REQUEST["txt_usua_codi"]) ? $_REQUEST["txt_usua_codi"] : "0";
        ...
        from (
            ...
            from (
                ...
                where r1.radi_inst_actu=" . $_SESSION["inst_codi"] . "
                    and r1.radi_nume_radi::text like '%1' and esta_codi in (0,2) $where
