...
if (isset ($replicacion) && $replicacion && $config_db_replica_adm_buscar_usuario_nuevo_subr_des!="") {
    $db = new ConnectionHandler(__DIR__, $config_db_replica_adm_buscar_usuario_nuevo_subr_des);
}
