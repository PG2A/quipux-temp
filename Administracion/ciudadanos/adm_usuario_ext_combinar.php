...
$paginador = new ADODB_Pager_Ajax(dirname(__DIR__, 2), "div_lista_personas", "busqueda_paginador.php", 'txt_buscar_nombre,tipo_query');

$ciu_nuevo = 1;
$cerrar = $_GET['cerrar'] ?? 'No';

// Initialize variables to prevent undefined warnings
$ciu_codigo = $ciu_codigo ?? "";
$ciu_cedula = $ciu_cedula ?? "";
$ciu_sincedula = $ciu_sincedula ?? "";
...
$ciu_codigo_eliminar = $ciu_codigo_eliminar ?? "";
...
<script type="text/javascript">
        ...
        function aceptar_cambios() {
            ...
            document.frm_confirmar.action='grabar_usuario_ext.php?cerrar=<?php echo $cerrar; ?>&accion=2';
