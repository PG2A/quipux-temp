...
$accion = 0 + ($_GET["accion"] ?? 0);
$txt_buscar_nombre = $_GET["txt_buscar_nombre"] ?? "";

$paginador = new ADODB_Pager_Ajax(dirname(__DIR__, 2), "div_buscar_ciudadanos", "busqueda_paginador.php",
