...
$accion_btn_cancelar =  "window.location='../ciudadanos/adm_ciudadano.php'"; // cxu revisar
$flag_login = true;
$ciu_ciudad =0;
$carp_codi = 80;
...
<body onload="validar_cambio_cedulajs(); mostrar_boton(); datosCiudad(<?=$ciu_ciudad?>) ">
  ...
  <form name='formulario' action="adm_sol_ciu_grabar.php" method="post" enctype="multipart/form-data">
    ...
    <?
    	...
    	echo "</tr><tr>";
            $label = "* Nombre: &nbsp;&nbsp;&nbsp;<img src=\"../../iconos/copy.gif\" alt=\"copiar\" title=\"Copiar datos del Registro Civil\" onclick=\"copiar_datos_registro_civil('nombre', 'ciu_nombre')\">";
            $ciud->dibujar_campo ("ciu_nombre", $ciu_nombre,$label, 150,"sol_estado",2); //, "onKeyUp='this.value=this.value.toUpperCase();'");
            $label = "* Apellido: &nbsp;&nbsp;&nbsp;<img src=\"../../iconos/copy.gif\" alt=\"copiar\" title=\"Copiar datos del Registro Civil\" onclick=\"copiar_datos_registro_civil('nombre', 'ciu_apellido')\">";
        ...
        ?>
            ...
            <td class="listado2" colspan="3">
                ...
                &nbsp<a href="javascript:;" onClick="descargar_contenido();" class="Ntooltip">
                    <img src="../../imagenes/document_down.jpg" width="17" height="17" alt="Descargar Acuerdo" border="0">
             ...
             <?php if($sol_estado == 2) {?>
                   ...
                   $url = __DIR__."/bodega/ciudadanos/".$ciu_codigo."_acuerdo.pdf.p7m";
                   ...
                   if (is_file($url)){ ?>       
                       ...
                       if($sol_estado!='3' && $sol_estado!='2'){                           
                            ...
                            echo '&nbsp;<img src="../../imagenes/close_button.gif" width="18" height="18" onClick="anexo_borrar_archivo(\'acuerdo\');" title="Eliminar Archivo" style="border: 0px solid gray;cursor:pointer;" alt="Eliminar Archivo"></a>';
                       }else{ 
