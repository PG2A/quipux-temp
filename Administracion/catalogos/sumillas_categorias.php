...
// Mismo contenedor que las bandejas de documentos, para heredar su estilo de
// tabla y de paginación.
$paginador = new ADODB_Pager_Ajax(dirname(__DIR__, 2), "div_cuerpo", "sumillas_categorias_paginador.php", "txt_buscar", "");
...
<script type="text/javascript">
    function sincronizar_busqueda() {
        ...
        var texto = document.getElementById('txt_buscar_categoria').value.replace(/^\s+|\s+$/g, '');
    ...
    function limpiar_busqueda() {
        document.getElementById('txt_buscar_categoria').value = '';
        realizar_busqueda();
    }
    ...
    function editar_categoria(cate_codi) {
        window.location = 'sumillas_categoria.php?txt_cate_codi=' + cate_codi;
    }
</script>
...
<form name="form1" id="form1" action="" method="POST" onsubmit="return false;">
    ...
    <table width="100%" class="borde_tab barra_busqueda_top" border="0" cellpadding="0" cellspacing="3">
        <tr>
            <td colspan="2" class="titulos4">Categor&iacute;as de Sumillas &nbsp;&ndash;&nbsp; <?php echo htmlspecialchars($inst_nombre); ?></td>
        </tr>
        <tr>
            <td colspan="2" class="listado2">
                Motivos por los que se emite un documento. Son las ramas del &aacute;rbol que el usuario
                recorre al reasignar; el orden fijado aqu&iacute; es el orden en que se muestran.
            </td>
        </tr>
        <tr>
            <td width="90%">
                <table width="100%" border="0">
                    <tr>
                        ...
                        <td width="81%" class="listado2">
                            <input type="text" name="txt_buscar_categoria" id="txt_buscar_categoria" size="40"
            ...
            <td width="10%" align="center">
                <input type="button" value="Buscar" name="Buscar" class="botones"
                       title="Busca el texto ingresado en el nombre de la categor&iacute;a" onclick="realizar_busqueda();">
    ...
    <div class="sumillas-botonera">
        <input type="button" name="btn_nueva" class="botones" value="Nueva Categor&iacute;a" onClick="editar_categoria('0');">
        <input type="button" name="btn_sumillas" class="botones" value="Ver Sumillas" onClick="window.location='sumillas_menu.php'">
