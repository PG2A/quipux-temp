...
//        oFCKeditor.ReplaceTextarea();
    ...
    function buscar_usuarios() {
        ...
        url = '../../radicacion/buscar_usuario_nuevo.php?documento_us1=' + document.formulario.documento_us1.value + '&documento_us2=-&ent=0';
                ...
                <form name="formulario" action="">
                    ...
                    <script type="text/javascript">
                        function refrescar_pagina(e) {
                            document.getElementById('ifr_usr').src = '../../radicacion/lista_concopiaa.php?documento_us1=' +
