...
//        }
//        else
            $cad.="<td width='10%' class='tooltip titulos3'><center><input type='button' name='btn_accion' class='botones_2' value='&gt;&gt;' onclick=\"mover_dato('$campo')\"/ title='De click para mover los datos..'></center></td>";
...
?>
 ...
 function imagen_imp($ruta_raiz,$cedula,$tipo){
  ...
  $html= '&nbsp<a href="javascript:;" onClick='.$funJava.' class="Ntooltip" >
                    <img name="img_reg'.$tipo.'" id="img_reg'.$tipo.'" '.$estilo.' src="../../imagenes/icono_buscar.png" width="40" height="40" alt="Consultar Datos de Registro Civil" title="Consultar Datos de Registro Civil" border="0">
                        </span></a>';
  return $html;
 }
 ?>   
...
<!--            <h3>Comparar datos de los ciudadanos</h3>-->
            ...
            <table width="100%" border="1" align="center" cellpadding="0" cellspacing="0" class="listado2">
                <tr>
                    ...
                    <td bgcolor="#ffffff" width="35%"><center><?php if (substr($new_cedula,0,2)=="99" or $new_sincedula == 1) echo "No tiene No. de c&eacute;dula"."<br>"; else echo imagen_imp('../..',$new_cedula,1);?>&nbsp;<?=$tmp_txt1?></center></td>
                    <td class='titulos3' width="10%">&nbsp;</td>
                    <td bgcolor="#ffffff" width="35%"><center><?php echo imagen_imp('../..',$old_cedula,2);?>&nbsp;<?=$tmp_txt2?></center></td>
                </tr>
                <tr>
