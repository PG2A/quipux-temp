...
require_once("../../js/ajax.js"); // teya 20110421
?>
    ...
    <center>
        <form name='formulario' action="adm_ciudadano_grabar.php" method="post">
            ...
            <table width="100%" border="1" align="center" class="borde_tab">
                ...
                echo "</tr><tr>";
                $label = "Direcci&oacute;n: &nbsp;&nbsp;&nbsp;<img src=\"../../iconos/copy.gif\" alt=\"copiar\" title=\"Copiar datos del Registro Civil\" onclick=\"copiar_datos_registro_civil('direccion', 'ciu_direccion')\">";
