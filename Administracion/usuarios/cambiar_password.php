...
<!DOCTYPE html>
    <?php echo
        html_head(); /*Imprime el head definido para el sistema*/
//        die();
    ?>
...
<!--    <script type="text/javascript" src="--><?php //=$ruta_raiz?><!--/js/md5.js"></script>-->
    ...
    <script language="JavaScript" type="text/JavaScript">
        ...
        //    window.location="<?php //=$ruta_raiz?>///index.php";
        //}
    ...
    <?php  if (!$flag) echo html_pie_pagina(); /*Imprime el pie de pagina del sistema*/ ?>
