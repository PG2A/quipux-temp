...
<?php  } ?>
    <tr>
            <!--<div id="div_validar_email" style="display: none;" ><?php if(validar_mail($usr_email)) echo "OK";?></div>-->
...
<!--		<div id='ciu_ciudad'><?=$ciu_ciudad?></div>-->
    ...
    ?>
	    ...
	    <td class="titulos2"> Direcci&oacute;n: &nbsp;&nbsp;&nbsp;
                ...
                <img src="/iconos/copy.gif" alt="copiar" title="Copiar datos del Registro Civil" onclick="copiar_datos_registro_civil('direccion', 'ciu_direccion')">
                <?php  //} ?>
            </td>
	    <td class="listado2">
	    ...
	    <td class="titulos2"> Contrase&ntilde;a: </td>
            <td class="listado2" colspan="3">
                <input type="checkbox" name="ciu_password" id="ciu_password" value="1" <?php if ($ciu_nuevo==0) echo "checked "; echo $read;?> <?=$deshabilitar_campos?>> Cambiar contrase&ntilde;a
	    </td>
