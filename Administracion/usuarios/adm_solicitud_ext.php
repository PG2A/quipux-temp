...
$accion_btn_cancelar = "window.location='../../Administracion/usuarios/cuerpoSolicitud_ext.php'";
 $flag_login = true;
...
?>
    ...
    function verificar_firma(nombre,n) {
        ...
        URL = '<?= __DIR__."/VerificarFirma.php?archivo="?>'+ nombre +'<?="&nombre_archivo="?>' + n;
...
<?php
    ...
    if($sol_acuerdo == 1){
            ...
            $path_descarga = "../../archivo_descargar.php?path_arch=/ciudadanos/$nombre_desc&nomb_arch=$nombre_desc";
