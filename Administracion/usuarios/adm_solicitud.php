...
$accion_btn_cancelar =  "window.location='../../cuerpo.php?nomcarpeta=$nombre&carpeta=$carp_codi&adodb_next_page=1'";
$flag_login = true;
...
<script type="text/javascript" language="JavaScript" src="../../js/validar_datos_usuarios.js"></script>
<script type="text/javascript" language="javascript">
    ...
    function verificar_firma(nombre,n) {
        ...
        URL = '<?="../../VerificarFirma.php?archivo="?>'+ nombre +'<?="&nombre_archivo="?>' + n;
    ...
    function anexo_cargar_archivo(id_objeto) {
        ...
        if (anexo_validar_tipo(archivo,id_objeto)) {
            document.getElementById('div_anexo_estado_'+id_objeto).innerHTML ='<img src="../../imagenes/progress_bar.gif">&nbsp;Cargando Archivo ';
    ...
    function anexo_borrar_archivo(id_objeto) {    
        if (confirm("Esta seguro/a que desea eliminar el archivo?")) {
            document.getElementById('div_anexo_estado_'+id_objeto).innerHTML ='<img src="../../imagenes/progress_bar.gif">&nbsp;Eliminando Archivo ';
...
//
        url = "../../descargar_contenidos.php?archivo="+path;
        ...
        function dibujar_campocombo ($campo, $label, $tamano, $opciones="") {
            ...
            $cad = "<td class='titulos2' width='20%'> $label </td>
                    ...
                    <select name='$campo' id='$campo' class='select'>
                         ...
                         <option value='2' <?php  if ($lista_orden == 2) echo selected; ?>>Archivo</option>
                   </select>
                   </td>";
            echo $cad;
            return;
...
<!--                    <select name='sol_firma' id='sol_firma' class='select'>                        
                         ...
                         <option value='2' <?php  if ($sol_firma == 2) echo "selected"; ?>>Archivo</option>
                   </select>-->
                        <?php                         
    	...
    	echo "</tr><tr>";
            $label = "* Nombre: &nbsp;&nbsp;&nbsp;<img src=\"".__DIR__."/iconos/copy.gif\" alt=\"copiar\" title=\"Copiar datos del Registro Civil\" onclick=\"copiar_datos_registro_civil('nombre', 'ciu_nombre')\">";
            dibujar_campo ("ciu_nombre", $label, 150,"sol_estado"); //, "onKeyUp='this.value=this.value.toUpperCase();'");
            $label = "* Apellido: &nbsp;&nbsp;&nbsp;<img src=\"".__DIR__."/iconos/copy.gif\" alt=\"copiar\" title=\"Copiar datos del Registro Civil\" onclick=\"copiar_datos_registro_civil('nombre', 'ciu_apellido')\">";
    	...
    	echo "</tr><tr>";
            $label = "Direcci&oacute;n: &nbsp;&nbsp;&nbsp;<img src=\"".__DIR__."/iconos/copy.gif\" alt=\"copiar\" title=\"Copiar datos del Registro Civil\" onclick=\"copiar_datos_registro_civil('direccion', 'ciu_direccion')\">";
...
/*
    ...
    if($sol_cedula == 1){
         ...
         $path_descarga = __DIR__."/archivo_descargar.php?path_arch=/ciudadanos/$nombre&nomb_arch=$nombre";
         ...
         if($sol_estado!='3' && $sol_estado!='2') $nombre_archivo .= "&nbsp;&nbsp;&nbsp;<img src='../imagenes/close_button.gif' width='20' height='18' onClick=\\\"anexo_borrar_archivo('cedula');\\\" title='Eliminar Archivo' style='border: 0px solid gray;cursor:pointer;' alt='Eliminar Archivo'>";
         //$nombre_archivo .= "&nbsp;&nbsp;&nbsp;<img src='../imagenes/close_button.gif' width='20' height='18' onClick=\\\"anexo_borrar_archivo('cedula');\\\" title='Eliminar Archivo' style='border: 0px solid gray;cursor:pointer;' alt='Eliminar Archivo'>";
   ...
   ?>
    ...
    if($sol_planilla == 1){
         ...
         $nombre_archivo .= "<a href=\\\"javascript:window.open('$path_descarga','_self','');\\\" class='vinculos'>$nombre</a>";
         if($sol_estado!='3' && $sol_estado!='2')$nombre_archivo .= "&nbsp;&nbsp;&nbsp;<img src='../imagenes/close_button.gif' width='20' height='18' onClick=\\\"anexo_borrar_archivo('planilla');\\\" title='Eliminar Archivo' style='border: 0px solid gray;cursor:pointer;' alt='Eliminar Archivo'>";
         //$nombre_archivo .= "&nbsp;&nbsp;&nbsp;<img src='../imagenes/close_button.gif' width='20' height='18' onClick=\\\"anexo_borrar_archivo('planilla');\\\" title='Eliminar Archivo' style='border: 0px solid gray;cursor:pointer;' alt='Eliminar Archivo'>";
         $nombre_archivo .= "</td></tr></table>";
         echo "<script>
...
<?php
    ...
    if($sol_acuerdo == 1){
            ...
            $path_descarga = "../../archivo_descargar.php?path_arch=/ciudadanos/$nombre_desc&nomb_arch=$nombre";
            $url = dirname(__DIR__, 2)."/bodega/ciudadanos/".$ciu_codigo."_acuerdo.pdf.p7m";
            ...
            if (is_file($url)){//url
                 ...
                 if($sol_estado!='3' && $sol_estado!='2')
                     $nombre_archivo .= "&nbsp;&nbsp;&nbsp;<img src='../imagenes/close_button.gif' width='20' height='18' onClick=\\\"anexo_borrar_archivo('acuerdo');\\\" title='Eliminar Archivo' style='border: 0px solid gray;cursor:pointer;' alt='Eliminar Archivo'>";         
                 $nombre_archivo .= "</td></tr></table>";
                 echo "<script>
