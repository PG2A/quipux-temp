...
if (isset ($replicacion) && $replicacion && $config_db_replica_lst_listas!="") {
    $db = new ConnectionHandler(__DIR__, $config_db_replica_lst_listas);
}
...
echo '<link rel="StyleSheet" href="../../js/nornix-treemenu-2.2.0/example/style/menu.css" type="text/css" media="screen" />
...
if (isset($_GET["lst_codigo"]) && $_GET["lst_codigo"]!='')
    $codigo_lista = $_GET["lst_codigo"];
else
    $codigo_lista = 0;
    
$lista_codi = $codigo_lista; // Ensure lista_codi is set for later use
$descCargo = $descCargo ?? "Cargo"; // Fallback if language file missing
$descEmpresa = $descEmpresa ?? "Institución"; // Fallback
$descRadicado = $descRadicado ?? "Radicado"; // Fallback
?>
...
<form method="post" name="formulario" id="formulario" action="" >
  <center>
    ...
    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
     <?php if (!isset($_GET['lst_codigo']) || $_GET['lst_codigo']==''){  ?>
