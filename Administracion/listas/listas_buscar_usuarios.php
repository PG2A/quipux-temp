...
$buscar_tipo_usuario = (int) ($_POST["txt_buscar_tipo_usuario"] ?? 0);
$buscar_dependencia = (int) ($_POST["txt_buscar_dependencia"] ?? 0);
$buscar_institucion = (int) ($_POST["txt_buscar_institucion"] ?? 0);
$lista_usuarios = "";
...
if ($buscar_nombre!="" or $buscar_cargo!="" or $buscar_institucion!="0" or $buscar_dependencia!="0" or $buscar_tipo_usuario >= 0) {
...
//echo $sql;
    ...
    while(!$rs->EOF)
    {
        ...
        if ($rs->fields["USO"] <= 50)
            $img_imagen = "<img src='../../imagenes/internas/user2.jpg' name='img_uso' border='0' title='".$rs->fields["USO"]." d&iacute;as sin uso'>";
        if ($rs->fields["USO"] <= 7)
            $img_imagen = "<img src='../../imagenes/internas/user1.jpg' name='img_uso' border='0' title='".$rs->fields["USO"]." d&iacute;as sin uso'>";
?>
