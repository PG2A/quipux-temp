...
$txt_resp_soli_codi = trim(limpiar_sql($_GET["txt_resp_soli_codi"]));
    ...
    if($txt_tipo_lista == 5 or ($txt_tipo_lista == 6 and $estado_solicitud == 1)){
        ...
        $link_selecciona_documento = '&nbsp<a href="javascript:;" onClick="metodoBuscarDocumento();" class="Ntooltip"><img src="/imagenes/document_attach.jpg" width="17" height="17" alt="Seleccionar Documento" border="0"><font color="blue">Seleccionar Documento</font></a>';
    ...
    if($txt_codigo_documento != "" && $txt_numero_documento != "")
        $link_ver_documento = '&nbsp<a href="javascript:;" onClick="metodoVerDocumento();" class="Ntooltip"><img src="/iconos/popup.png" width="17" height="17" alt="Ver Documento" border="0"><font color="blue"></font></a>';
