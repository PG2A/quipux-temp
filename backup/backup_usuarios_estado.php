...
$paginador = new ADODB_Pager_Ajax(dirname(__DIR__), "div_buscar_respaldos", "backup_usuarios_estado_buscar.php", "cmb_institucion,cmb_estado,txt_fecha_inicio_sol,txt_fecha_fin_sol","");
