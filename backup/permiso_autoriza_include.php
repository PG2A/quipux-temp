...
include_once(dirname(__DIR__)."/Administracion/usuarios/mnuUsuariosH.php");
  //Se consulta áreas
...
?>
<script type="text/javascript" src="/Administracion/ciudadanos/adm_ciudadanos.js"></script>
