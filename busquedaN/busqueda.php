...
//session_start();
$ruta_raiz = dirname(__DIR__);
if (isset($replicacion) && $replicacion && isset($config_db_replica_busqueda) && $config_db_replica_busqueda!="") {
    $db = new ConnectionHandler($ruta_raiz, $config_db_replica_busqueda);
}
...
if (!isset($numeroCaracteresTexto)) $numeroCaracteresTexto = 0;
$txt_buscar = isset($_POST["txt_buscar"]) ? (int)$_POST["txt_buscar"] : 0;

$txt_estado = isset($_POST["txt_estado"]) ? limpiar_sql($_POST["txt_estado"]) : 999;
$txt_reporte = isset($_POST["txt_reporte"]) ? limpiar_sql($_POST["txt_reporte"]) : "";
$txt_sino_firma = isset($_POST["txt_sino_firma"]) ? limpiar_sql($_POST["txt_sino_firma"]) : 2;
$txt_nume_documento  = isset($_POST["txt_nume_documento"]) ? limpiar_sql($_POST["txt_nume_documento"]) : "";
$txt_nume_referencia = isset($_POST["txt_nume_referencia"]) ? limpiar_sql($_POST["txt_nume_referencia"]) : "";
//$txt_usua_remitente = limpiar_sql($_POST["txt_usua_remitente"]);
$txt_usua_destinatario = isset($_POST["txt_usua_destinatario"]) ? limpiar_sql($_POST["txt_usua_destinatario"]) : "";

$txt_texto = isset($_POST["txt_texto"]) ? limpiar_sql($_POST["txt_texto"]) : "";
$txt_tipo_documento = isset($_POST["txt_tipo_documento"]) ? limpiar_sql($_POST["txt_tipo_documento"]) : 0;
$txt_categoria = isset($_POST["txt_categoria"]) ? limpiar_sql($_POST["txt_categoria"]) : "";
$txt_tipificacion = isset($_POST["txt_tipificacion"]) ? limpiar_sql($_POST["txt_tipificacion"]) : "";
$txt_campo_metadato = isset($_POST["txt_campo_metadato"]) ? limpiar_sql($_POST["txt_campo_metadato"]) : "";
//tipo: de para copia
$txt_de_para_copia = isset($_POST["txt_de_para_copia"]) ? (int)limpiar_sql($_POST["txt_de_para_copia"]) : 1;
if (!isset($_POST["txt_de_para_copia"]))
    $txt_de_para_copia=1;
//id_destinatario
$txt_usua_destinatario_h = isset($_POST["txt_usua_destinatario_h"]) ? (int)limpiar_sql($_POST["txt_usua_destinatario_h"]) : 0;

$txt_de_para_ex = isset($_POST["txt_de_para_ex"]) ? (int)limpiar_sql($_POST["txt_de_para_ex"]) : 2;
if (!isset($_POST["txt_de_para_ex"]))
    $txt_de_para_ex=2;
$txt_usua_para = isset($_POST["txt_usua_para"]) ? limpiar_sql($_POST["txt_usua_para"]) : "";
$txt_usua_para_h = isset($_POST["txt_usua_para_h"]) ? (int)limpiar_sql($_POST["txt_usua_para_h"]) : 0;


//institucion
$txt_inst_codi = isset($_POST["txt_inst_codi"]) ? limpiar_numero($_POST["txt_inst_codi"]) : $_SESSION["inst_codi"];

if (isset($_POST["txt_inst_codi"]) && isset($_SESSION["perm_buscar_doc_adscritas"]) && $_SESSION["perm_buscar_doc_adscritas"] == 1 && ((int)$_POST["txt_inst_codi"])!=$_SESSION["inst_codi"]) {
    $txt_inst_codi = (int)limpiar_numero($_POST["txt_inst_codi"]);
...
$rs = $db->conn->query("select inst_nombre from institucion where inst_codi=$txt_inst_codi");
    $span_inst_nombre = isset($rs->fields["INST_NOMBRE"]) ? $rs->fields["INST_NOMBRE"] : (isset($rs->fields["inst_nombre"]) ? $rs->fields["inst_nombre"] : "");
...
if (!isset($descRadicado)) $descRadicado = "No. Radicado";
if (!isset($descReferencia)) $descReferencia = "No. Referencia";
if (!isset($descEmpresa)) $descEmpresa = "Empresa";
if (!isset($descDependencia)) $descDependencia = "Dependencia";

$txt_buscar = isset($_POST["txt_buscar"]) ? 0+$_POST["txt_buscar"] : 0;

if ($txt_depe_codi==$_SESSION["depe_codi"]) $span_depe_nombre = isset($_SESSION["depe_nomb"]) ? $_SESSION["depe_nomb"] : "";
elseif ($txt_depe_codi == 0) $span_depe_nombre = "&lt;&lt Todas las &aacute;reas &gt;&gt;";
    ...
    $span_depe_nombre = isset($rs->fields["DEPE_NOMB"]) ? $rs->fields["DEPE_NOMB"] : (isset($rs->fields["depe_nomb"]) ? $rs->fields["depe_nomb"] : "");
}
...
if ($txt_usua_codi == 0) $span_usua_nombre = "&lt;&lt Todos los usuarios &gt;&gt;";
    ...
    $usua_apellido = isset($rs->fields["USUA_APELLIDO"]) ? $rs->fields["USUA_APELLIDO"] : (isset($rs->fields["usua_apellido"]) ? $rs->fields["usua_apellido"] : "");
    $usua_nomb = isset($rs->fields["USUA_NOMB"]) ? $rs->fields["USUA_NOMB"] : (isset($rs->fields["usua_nomb"]) ? $rs->fields["usua_nomb"] : "");
    $span_usua_nombre = $usua_apellido." ".$usua_nomb;
}
...
//              + "&lista_modificada="+document.formulario.hidden_lista_modificada.value;
    ...
    function busqueda_buscar_documento(tipo) {
        ...
        numeroCaracteres=parseInt('<?=(int)$numeroCaracteresTexto?>');;
...
?>
            ...
            <tr>
                ...
                <td class="listado2">
                    ...
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <input type="radio" name="txt_tipo_fecha" id="txt_tipo_fecha" value="1" <?php if (isset($_POST["txt_tipo_fecha"]) && $_POST["txt_tipo_fecha"]=="1") echo "checked";?>>Registro
                </td>
                <td width="30%" class="listado2">&nbsp;
                </td>
            </tr>
          ...
          <tr style='display: <?= (isset($_SESSION["perm_buscar_doc_adscritas"]) && $_SESSION["perm_buscar_doc_adscritas"]==1) ? "" : "none";?>;'>
                ...
                <td class="listado2"> 
                    ...
                    <img src="../imagenes/internas/pencil_add.png" onclick='fjs_buscar_cambiar_combo("inst");' id="img_inst_cambiar" align="middle" border="0" title="Cambiar de institucion" alt="cambiar">
                </td>
                <td width="30%" class="listado2">&nbsp;</td>
            </tr>
           <tr>
                ...
                <td class="listado2">
                    ...
                    <img src="../imagenes/internas/pencil_add.png" onclick='fjs_buscar_cambiar_combo("depe");' id="img_depe_cambiar" align="middle" border="0" title="Cambiar de <?=$txt_depe_codi?>" alt="cambiar">
                </td>
                <td width="30%" class="listado2">&nbsp;</td>
            </tr>
        <tr>
                ...
                <td class="listado2">
                    ...
                    <img src="../imagenes/internas/pencil_add.png" onclick='fjs_buscar_cambiar_combo("usua");' id="img_usua_cambiar" align="middle" border="0" title="Cambiar de <?=$txt_usua_codi?>" alt="cambiar">
                </td>
                <td width="30%" class="listado2">&nbsp;
                </td>
            </tr>
