...
if (isset ($replicacion) && $replicacion && $config_db_replica_buscar_usuario_nuevo!="") {
    $db = new ConnectionHandler(__DIR__, $config_db_replica_buscar_usuario_nuevo);
}
...
if (!isset($lista_modificada)) $lista_modificada = 0;
if (!isset($buscar_nom)) $buscar_nom = "";
if (!isset($numeroCaracteresTexto)) $numeroCaracteresTexto = 0;
if (!isset($descEmpresa)) $descEmpresa = "Institución";
