		...
		*/
		...
		protected function setHeader() {
			if ($this->print_header) {
				...
				if (isset($this->header_font) && is_array($this->header_font) && count($this->header_font) >= 3) {
		...
		protected function setFooter() {
			...
			if ($this->print_footer) {
				...
				if (isset($this->footer_font) && is_array($this->footer_font) && count($this->footer_font) >= 3) {
		...
		*/
		public function Image($file, $x, $y, $w=0, $h=0, $type='', $link='', $align='', $resize=false, $dpi=300, $palign='') {
			...
			if (!isset($this->images[$file])) {
				...
				$mqr = 0; //get_magic_quotes_runtime();
