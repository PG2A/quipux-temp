...
////se camiba para que tome los datos de la sesion
$usr = strtoupper(limpiar_sql($$_SESSION["krd"]));
...
<!DOCTYPE html>
    ...
    <script type="text/javascript">
        function login_olvido_contraseña() {
            ...
            url = '/Administracion/usuarios/cambiar_password_olvido.php';
...
<?
        ...
        if ($usr_email!="" and strpos($usr_email,"@") and strpos($usr_email,".",strpos($usr_email,"@"))) {
            ...
            include_once(__DIR__.'/Administracion/usuarios/cambiar_password_mail.php');
