...
if (isset ($replicacion) && $replicacion && $config_db_replica_info_ver_historico!="") $db = new ConnectionHandler(__DIR__,$config_db_replica_info_ver_historico);
...
<script language="javascript" type="text/javascript">
    ...
    function ver_historico_imprimir_hoja_ruta() {
        ...
        window.open('reportes/generar_reporte_recorrido.php?verrad=<?=$verrad?>&imprimir_comentarios='+imprimir_comentarios,
                    'hoja_ruta_<?=$verrad?>');
    }
        ...
        <td colspan="4">
            <table  width="100%" align="center" border="0" cellpadding="0" cellspacing="3" class="borde_tab" >
                ...
                <tr align="center">
                    ...
                    <?php /*if ($nivel_seguridad_documento>=2) echo "<th>Comentario</th>"; */?>
                    <th>Comentario</th>
                </tr>
  <?php
    $where = "";
...
<center>
    ...
    <br>&nbsp;
    <iframe name="ifr_descargar_archivo" id="ifr_descargar_archivo" style="display: none;" src=""></iframe>
</center>
</body>
</html>
